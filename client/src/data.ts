...
export type AssociationCase = {
  ...
  requirement: string;
  /**
   * عدد مرات تحويل الحالة بين الجهات، وعدد مرات تواصل المستفيد دون تقدّم.
   * كانا يُشتقّان سابقًا بمطابقة نصية على عناوين السجل، ولم يكن في السجل أي
   * عنوان يحتوي «تحويل» أو «تواصل»، فكانت القيمتان صفرًا دائمًا وإشارتا
   * التوقّف المبنيتان عليهما لا تعملان إطلاقًا. صارتا الآن بيانات صريحة.
   */
...
export const associationCases: AssociationCase[] = [
  { id: "SKN-2841", name: "أحمد محمد", stage: "التخصيص", daysInStage: 18, daysSinceUpdate: 12, status: "تحتاج تدخل", alert: "لم يحدث تحديث على الطلب منذ 12 يومًا", action: "مراجعة حالة التخصيص", owner: "الجمعية", lastUpdated: "12 أغسطس 2026", priority: "تحتاج تدخل", region: "الرياض", requirement: "مكتمل", reassignments: 3, beneficiaryContacts: 2, nextStep: "التواصل مع مسؤول التخصيص للتحقق من حالة الطلب.", stageEntered: "7 أغسطس 2026", lastAction: "تم إرسال تنبيه للجمعية", history: [{ date: "24 أغسطس 2026", title: "تمت مراجعة الحالة من الجمعية", body: "تم فتح الحالة للتدخل الاستباقي." }, { date: "18 أغسطس 2026", title: "انتقل الطلب إلى التخصيص", body: "بدأت مطابقة الوحدة المناسبة." }, { date: "12 أغسطس 2026", title: "لا يوجد تحديث جديد", body: "تم إنشاء تنبيه متابعة للجمعية." }] },
  { id: "SKN-2917", name: "فاطمة علي", stage: "استكمال المتطلبات", daysInStage: 6, daysSinceUpdate: 0, status: "جاهزة للانتقال", alert: "جميع المتطلبات مكتملة", action: "مراجعة الحالة", owner: "الجهة المختصة", lastUpdated: "24 أغسطس 2026", priority: "تحتاج متابعة", region: "الرياض", requirement: "مكتمل", reassignments: 0, beneficiaryContacts: 0, nextStep: "مراجعة اكتمال الملف قبل الإحالة للمرحلة التالية.", stageEntered: "18 أغسطس 2026", lastAction: "تم استكمال إثبات السكن", history: [{ date: "24 أغسطس 2026", title: "اكتملت المتطلبات", body: "الحالة جاهزة للمراجعة وليست اعتمادًا نهائيًا." }, { date: "21 أغسطس 2026", title: "تم استكمال إثبات السكن", body: "تم تحديث المستند من المستفيد." }] },
  { id: "SKN-3052", name: "سالم القحطاني", stage: "التحقق من البيانات", daysInStage: 17, daysSinceUpdate: 15, status: "متطلبات ناقصة", alert: "متطلب ناقص يمنع تقدم الطلب", action: "متابعة المستند", owner: "المستفيد", lastUpdated: "9 أغسطس 2026", priority: "تحتاج متابعة", region: "الرياض", requirement: "ناقص", reassignments: 1, beneficiaryContacts: 3, nextStep: "تذكير المستفيد بتحديث بيانات الدخل.", stageEntered: "8 أغسطس 2026", lastAction: "طلب استكمال بيانات الدخل", history: [{ date: "9 أغسطس 2026", title: "طلب استكمال بيانات الدخل", body: "ينتظر الطلب مستندًا من المستفيد." }] },
  { id: "SKN-3194", name: "سارة عبدالله", stage: "التحقق من البيانات", daysInStage: 14, daysSinceUpdate: 14, status: "متأخرة", alert: "إثبات السكن يحتاج تحديث", action: "عرض الحالة", owner: "المستفيد", lastUpdated: "10 أغسطس 2026", priority: "تحتاج تدخل", region: "الرياض", requirement: "قيد المراجعة", reassignments: 0, beneficiaryContacts: 2, nextStep: "التحقق من وصول إثبات السكن المحدث.", stageEntered: "10 أغسطس 2026", lastAction: "إرسال تذكير بالمستند", history: [{ date: "10 أغسطس 2026", title: "إثبات السكن يحتاج تحديث", body: "أُرسل تنبيه للمستفيد." }] },
  { id: "SKN-3260", name: "محمد سالم", stage: "التخصيص", daysInStage: 21, daysSinceUpdate: 21, status: "تجاوزت مدة المرحلة", alert: "لا يوجد تحديث على الطلب منذ فترة", action: "تسجيل متابعة", owner: "الجهة المختصة", lastUpdated: "3 أغسطس 2026", priority: "تحتاج تدخل", region: "الرياض", requirement: "مكتمل", reassignments: 2, beneficiaryContacts: 1, nextStep: "طلب مراجعة من الجهة للتحقق من حالة التخصيص.", stageEntered: "3 أغسطس 2026", lastAction: "إضافة إلى قائمة التخصيص", history: [{ date: "3 أغسطس 2026", title: "انتقل الطلب إلى التخصيص", body: "لم يصل تحديث منذ ذلك التاريخ." }] },
  { id: "SKN-3321", name: "ريم الحربي", stage: "استكمال الإجراءات", daysInStage: 4, daysSinceUpdate: 2, status: "عادية", alert: "تسير الحالة ضمن المدة التجريبية", action: "فتح الحالة", owner: "الجمعية", lastUpdated: "22 أغسطس 2026", priority: "عادية", region: "الرياض", requirement: "قيد المراجعة", reassignments: 0, beneficiaryContacts: 0, nextStep: "متابعة اكتمال الإجراء الحالي.", stageEntered: "20 أغسطس 2026", lastAction: "تمت مراجعة الملف", history: [{ date: "22 أغسطس 2026", title: "تمت مراجعة الملف", body: "لا يوجد إجراء عاجل حاليًا." }] },
];
